...
@rem Example 2: build-zeppobox dita2epub
@rem The variable pubname should have the value of the name of the ditamap without extension

ant -f C:/Users/A.Petersell/Dropbox/DITA-SRCME/seminarwork-dokumentation/build-petersell.xml -Dpubname=dokumentation -logger org.dita.dost.log.DITAOTBuildLogger %1
