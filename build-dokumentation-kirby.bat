...
ant -f C:/Users/A.Petersell/Dropbox/DITA-SRCME/seminarwork-dokumentation/build-petersell.xml -Dpubname=dokumentation-kirby -logger org.dita.dost.log.DITAOTBuildLogger %1